...
public class Module implements Comparable<Module> {
	...
	public String toString() {
		...
		// so as to assist in displaying modules correctly in a ListView<Module> in the
		// view
	...
	public String actualToString() {
		return "Module:[moduleCode=" + moduleCode + ", moduleName=" + moduleName + ", credits=" + credits
				+ ", mandatory=" + mandatory + ", runPlan=" + runPlan + "]";
	}
